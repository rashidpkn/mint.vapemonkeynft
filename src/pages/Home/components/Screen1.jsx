...
function Screen1() {
    ...
    return (
        <div className="screen1 h-[600px] px-[10%] flex justify-center  flex-col gap-10 lg:border-b relative">
            <h1 data-aos="fade-up" className='text-4xl lg:text-6xl font-bold'>Get your <br /> Vape Monkey NFT Ape NFT</h1>
            <p className='w-full lg:w-1/2 text-xl font-medium'>Once upon a time in a land far far away, there was a special kind of Ape that originated somewhere in Eastern Europe. It has conquered our world and is now on a new journey to take over the metaverse.</p>
